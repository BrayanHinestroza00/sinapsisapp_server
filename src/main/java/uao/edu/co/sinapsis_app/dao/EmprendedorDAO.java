...
//        return true;
    ...
    public ActividadRutaEmp buscarActividadRutaEmp(Long subActividadRutaId, Long rutaEmprendimientoId) {
        String sql = "SELECT TARE.* FROM T_SINAPSIS_SUB_ACT_RUTAS_EMP TSARE \n" +
                ...
                "WHERE TARE.RUTAS_EMPRENDIMIENTOS_ID = TSARE.RUTAS_EMPRENDIMIENTOS_ID AND TSARE.RUTAS_EMPRENDIMIENTOS_ID = ?1 AND TSARE.SUB_ACTIVIDADES_RUTAS_ID = ?2 AND TARE.ESTADO = 'PENDIENTE'";
